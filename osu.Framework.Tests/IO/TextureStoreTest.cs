...
namespace osu.Framework.Tests.IO
{
    ...
    public class TextureStoreTest
    {
        ...
        public void TestLookupStores()
        {
            ...
            using (var textureStore = new TextureStore(new OpenGLRenderer(), scaleAdjust: 100))
            {
        ...
        {
            using (var textureStore = new TextureStore(new OpenGLRenderer(), new NamespacedResourceStore<TextureUpload>(fontResourceStore, "Roboto"), scaleAdjust: 100))
            using (var nestedTextureStore = new TextureStore(new OpenGLRenderer(), new NamespacedResourceStore<TextureUpload>(fontResourceStore, "RobotoCondensed"), scaleAdjust: 200))
            {
