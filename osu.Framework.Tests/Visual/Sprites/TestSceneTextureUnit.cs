    ...
    public class TestSceneTextureUnit : GridTestScene
    {
        ...
        private class TestSprite : Sprite
        {
            ...
            private void load(GameHost host)
            {
                ...
                Texture = createTexture(host, new Rgba32(255, 255, 255, 255));
                redTex = createTexture(host, new Rgba32(255, 0, 0, 255));
                greenTex = createTexture(host, new Rgba32(0, 255, 0, 255));
                blueTex = createTexture(host, new Rgba32(0, 0, 255, 255));
            }

            private Texture createTexture(GameHost host, Rgba32 pixel)
            {
            ...
            private class TestBoxDrawNode : SpriteDrawNode
            {
                ...
                {
                    renderer.BindTexture(redTex, TextureUnit.Texture1);
                    renderer.BindTexture(greenTex, TextureUnit.Texture2);
