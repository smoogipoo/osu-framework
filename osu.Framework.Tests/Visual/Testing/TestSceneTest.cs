...
namespace osu.Framework.Tests.Visual.Testing
{
    public partial class TestSceneTest : FrameworkTestScene
    {
        ...
        public virtual void SetUp()
        {
            ...
            if (DebugUtils.IsTestRunning && TestContext.CurrentContext.Test.MethodName == nameof(TestConstructor))
                return;
        ...
        public void TestTest()
        {
            ...
            //
            AddAssert("correct [SetUp] run count", () => setupRun == (DebugUtils.IsTestRunning ? testRunCount : testRunCountDummyRun));
        ...
        protected internal override ITestSceneTestRunner CreateRunner() => new TestRunner();

        private partial class TestRunner : TestSceneTestRunner
        {
            public override void RunTestBlocking(AdhocTestScene test)
            {
