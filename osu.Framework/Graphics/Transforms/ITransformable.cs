...
namespace osu.Framework.Graphics.Transforms
{
    public interface ITransformable
    {
        ...
        DelayedSequence BeginDelayedSequence(double delay, bool recursive = true);
        ...
        AbsoluteSequence BeginAbsoluteSequence(double newTransformStartTime, bool recursive = true);
