...
namespace osu.Framework.Graphics.Veldrid.Buffers
{
    ...
    /// </summary>
    public class VeldridLinearVertexBuffer<T> : VeldridVertexBuffer<T>
        where T : struct, IEquatable<T>, IVertex
    {
        private readonly VeldridRenderer renderer;
        private readonly int amountVertices;

        internal VeldridLinearVertexBuffer(VeldridRenderer renderer, int amountVertices, PrimitiveTopology type, BufferUsage usage)
