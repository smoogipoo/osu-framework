...
namespace osu.Framework.Graphics.Veldrid.Shaders
{
    internal class VeldridShaderPart : IShaderPart
    {
        ...
        public VeldridShaderPart(VeldridRenderer renderer, byte[]? data, ShaderPartType type, IShaderStore store)
        {
            ...
            code = last_input_pattern.Replace(code, match => $"layout(location = {++lastInputIndex}) in");
        ...
        private VeldridShaderPart(VeldridRenderer renderer, string code, string header, ShaderPartType type, IShaderStore store)
        {
            this.renderer = renderer;
            this.code = code;
            this.header = header;
        ...
        public VeldridShaderPart WithPassthroughInput(IReadOnlyList<VeldridShaderAttribute> attributes)
        {
            ...
            var part = new VeldridShaderPart(renderer, result, header, Type, store);
