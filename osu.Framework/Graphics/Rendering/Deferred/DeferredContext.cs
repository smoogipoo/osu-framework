...
namespace osu.Framework.Graphics.Rendering.Deferred
{
    internal class DeferredContext
    {
        ...
        public ResourceReference Reference<T>(T obj) where T : class => Allocator.Reference(obj);

        public object Dereference(ResourceReference reference) => Allocator.Dereference(reference);
        ...
        public void EnqueueEvent<T>(in T renderEvent) where T : unmanaged, IRenderEvent => RenderEvents.Enqueue(renderEvent);
    }
}
