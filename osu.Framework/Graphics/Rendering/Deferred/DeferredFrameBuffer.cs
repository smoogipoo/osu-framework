    ...
    internal class DeferredFrameBuffer : IFrameBuffer, IVeldridFrameBuffer
    {
        ...
        Vector2 IFrameBuffer.Size
        {
            ...
            set
            {
                ...
                renderer.EnqueueEvent(new ResizeFrameBufferEvent(renderer.Reference(this), size));
            }
        }
        ...
        private sealed class DeferredFrameBufferTexture : INativeTexture, IVeldridTexture
        {
            ...
            int INativeTexture.GetByteSize() => deferredFrameBuffer.size.X * deferredFrameBuffer.size.Y * 4;
