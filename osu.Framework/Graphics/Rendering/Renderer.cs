...
namespace osu.Framework.Graphics.Rendering
{
    ...
    public abstract class Renderer : IRenderer
    {
        ...
        public void DrawVertices(PrimitiveTopology type, int vertexStart, int verticesCount)
        {
            ...
            DrawVerticesImplementation(type, vertexStart, verticesCount);
        }

        public abstract void DrawVerticesImplementation(PrimitiveTopology type, int vertexStart, int verticesCount);
