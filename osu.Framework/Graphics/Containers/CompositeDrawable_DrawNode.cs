...
namespace osu.Framework.Graphics.Containers
{
    public partial class CompositeDrawable
    {
        ...
        protected class CompositeDrawableDrawNode : DrawNode, ICompositeDrawNode
        {
            ...
            /// <summary>
            /// The screen-space version of <see cref="MaskingInfo.MaskingSpaceRect"/>.
            ...
            public override void ApplyState()
            {
                ...
                maskingInfo = !Source.Masking
                    ...
                    : new MaskingInfo
                    {
                        ScissorRect = Source.ScreenSpaceDrawQuad.AABB,
                        MaskingSpaceRect = Source.DrawRectangle.Normalize(),
            ...
            private void drawEdgeEffect(IRenderer renderer)
            {
                ...
                RectangleF effectRect = maskingInfo.Value.MaskingSpaceRect.Inflate(edgeEffect.Radius).Offset(edgeEffect.Offset);

                screenSpaceMaskingQuad ??= Quad.FromRectangle(effectRect) * DrawInfo.Matrix;

                MaskingInfo edgeEffectMaskingInfo = maskingInfo.Value;
                edgeEffectMaskingInfo.MaskingSpaceRect = effectRect;
                edgeEffectMaskingInfo.ScissorRect = screenSpaceMaskingQuad.Value.AABB;
