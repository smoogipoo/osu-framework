...
namespace osu.Framework.Graphics
{
    public static class Vector2Extensions
    {
        ...
        {
            float w = mat.Row0.Z * pos.X + mat.Row1.Z * pos.Y + mat.Row2.Z;
            result.X = (mat.Row0.X * pos.X + mat.Row1.X * pos.Y + mat.Row2.X) / w;
            result.Y = (mat.Row0.Y * pos.X + mat.Row1.Y * pos.Y + mat.Row2.Y) / w;
        }
