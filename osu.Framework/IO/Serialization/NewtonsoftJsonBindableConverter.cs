...
namespace osu.Framework.IO.Serialization
{
    ...
    /// </summary>
    internal class NewtonsoftJsonBindableConverter : JsonConverter<ISerializableBindable>
    {
        ...
        public override ISerializableBindable ReadJson(JsonReader reader, Type objectType, ISerializableBindable? existingValue, bool hasExistingValue,
