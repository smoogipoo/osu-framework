...
{
    internal class PassthroughBassAudioMixer : AudioMixer, IBassAudioMixer
    {
        public PassthroughBassAudioMixer(AudioMixer? fallbackMixer, string identifier)
        ...
        public bool ChannelPlay(IBassAudioChannel channel, bool restart = false)
            => ManagedBass.Bass.ChannelPlay(channel.Handle, restart);
