...
namespace osu.Framework.Audio.Mixing.Bass
{
    internal interface IBassAudioMixer : IAudioMixer
    {
        ...
        /// <para>
        /// This will change the timing of <see cref="Bass.LastError"/>, so should be used sparingly.
        /// </para>
        /// </param>
        /// <returns>
        /// If successful, <see langword="true"/> is returned, else <see langword="false"/> is returned.
        /// Use <see cref="ManagedBass"/> to get the error code.
        /// </returns>
        ...
        /// </summary>
        /// <remarks>See: <see cref="BassMix.ChannelSetSync(int,ManagedBass.SyncFlags,long,ManagedBass.SyncProcedure,System.IntPtr)"/>.</remarks>
